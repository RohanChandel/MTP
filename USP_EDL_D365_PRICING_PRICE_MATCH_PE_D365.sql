CREATE PROC [EXTRACT_MDATA].[USP_EDL_D365_PRICING_PRICE_MATCH_PE_D365] AS
...
FROM [EDL_MDATA].[MET_PRICINGPROFILELINE] PROFILELINE
    ...
    Select * from  EXTRACT_MDATA.EDL_D365_PRICING_PRICE_MATCH   --Temporary table created in Pipeline for PE data      
END